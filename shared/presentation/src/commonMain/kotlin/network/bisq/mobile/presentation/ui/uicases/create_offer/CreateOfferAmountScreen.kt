    ...
    MultiScreenWizardScaffold(
        ...
        if (presenter.amountType.collectAsState().value == AmountType.FIXED_AMOUNT) {
            BisqAmountSelector(
                ...
                sliderPosition = presenter._fixedAmountSliderPosition.collectAsState().value,
            ...
            RangeAmountSelector(
                ...
                formattedMaxAmount = presenter.formattedMaxAmountWithCode,
                quoteCurrencyCode = presenter.quoteCurrencyCode,
                minRangeSliderValue = presenter._minRangeInitialSliderValue.collectAsState().value,
                onMinRangeSliderValueChange = { presenter.onMinRangeSliderValueChange(it) },
                maxRangeSliderValue = presenter._maxRangeInitialSliderValue.collectAsState().value,
