...
fun customPaymentOverlayLetterColor(darkColor: Color, lightColor: Color): Color =
    if (isIOSPlatform()) lightColor else darkColor
...
val CUSTOM_PAYMENT_BACKGROUND_COLORS = listOf(
