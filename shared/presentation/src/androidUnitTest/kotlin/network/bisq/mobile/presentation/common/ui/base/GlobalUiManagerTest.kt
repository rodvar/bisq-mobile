...
class GlobalUiManagerTest {
    ...
    @Test
    fun scheduleShowLoading_showsDialogAfterGraceDelay() = runTest(testDispatcher) {
        // Given
        val globalUiManager = GlobalUiManager(testDispatcher)
    ...
    @Test
    fun hideLoading_hidesDialog_afterGraceDelayExpires() = runTest(testDispatcher) {
        // Given
        val globalUiManager = GlobalUiManager(testDispatcher)
    ...
    @Test
    fun multipleScheduleShowLoading_cancelsPreviousJob() = runTest(testDispatcher) {
        // Given
        val globalUiManager = GlobalUiManager(testDispatcher)
    ...
    @Test
    fun graceDelay_showsDialogOnSlowOperations() = runTest(testDispatcher) {
        // Given
        val globalUiManager = GlobalUiManager(testDispatcher)
