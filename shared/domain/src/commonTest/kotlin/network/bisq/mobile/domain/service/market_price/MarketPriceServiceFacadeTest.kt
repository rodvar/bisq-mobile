...
class MarketPriceServiceFacadeTest : KoinTest {
    ...
    @Test
    fun testRestoreSelectedMarketWithInvalidCode() =
        runBlocking {
    ...
    private class TestMarketPriceServiceFacade(
        ...
        override fun findUSDMarketPriceItem(): MarketPriceItem? = testMarketPriceItem.value
