...
class UserRepositoryImplTest {
    ...
    @Test
    fun `data flow should return user data from datastore`() =
        runTest {
            // Given
            val expectedUser =
                User(
    ...
    @Test
    fun `data flow should emit default user on IOException and log error`() =
        runTest {
            // Given
    ...
    @Test
    fun `updateTerms should update user trade terms`() =
        runTest {
            // Given
    ...
    @Test
    fun `updateStatement should update user statement`() =
        runTest {
            // Given
            val updateSlot = slot<suspend (User) -> User>()
            coEvery { mockDataStore.updateData(capture(updateSlot)) } returns User()
    ...
    @Test
    fun `update should replace entire user`() =
        runTest {
            // Given
            val updateSlot = slot<suspend (User) -> User>()
            coEvery { mockDataStore.updateData(capture(updateSlot)) } returns User()
    ...
    @Test
    fun `clear should reset user to default`() =
        runTest {
            // Given
            val updateSlot = slot<suspend (User) -> User>()
            coEvery { mockDataStore.updateData(capture(updateSlot)) } returns User()
