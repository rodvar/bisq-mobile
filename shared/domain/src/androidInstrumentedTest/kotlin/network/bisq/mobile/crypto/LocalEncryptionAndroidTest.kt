...
class LocalEncryptionInstrumentedTest {
    ...
    @Test
    fun encryptReturnsNonEmptyByteArray() = runTest {
    ...
    @Test
    fun encryptReturnsDifferentDataThanPlaintext() = runTest {
        val plaintext = "Hello, World!".toByteArray()
    ...
    @Test
    fun decryptReturnsOriginalPlaintext() = runTest {
        val plaintext = "Hello, World!".toByteArray()
    ...
    @Test
    fun encryptAndDecryptWithEmptyData() = runTest {
    ...
    @Test
    fun encryptAndDecryptWithLargeData() = runTest {
    ...
    @Test
    fun encryptProducesDifferentCiphertextEachTimeDueToRandomIV() = runTest {
        val plaintext = "Hello, World!".toByteArray()
    ...
    @Test
    fun decryptWorksWithDifferentEncryptionsOfSamePlaintext() = runTest {
        val plaintext = "Hello, World!".toByteArray()
    ...
    @Test
    fun encryptedDataIncludesIVPrefix() = runTest {
        val plaintext = "Hello, World!".toByteArray()
    ...
    @Test
    fun encryptAndDecryptWithUnicodeData() = runTest {
    ...
    @Test
    fun multipleKeysWorkIndependently() = runTest {
    ...
    @Test
    fun reusesSameKeyForSameAlias() = runTest {
    ...
    @Test
    fun decryptFailsWhenDataIsTampered() = runTest {
        val plaintext = "Hello, World!".toByteArray()
