...
class WiseFormContentTest {
    ...
    fun `when picker clear all clicked then currency summary updates through presenter`() {
        ...
        composeTestRule.waitForIdle()
        composeTestRule
            .onAllNodesWithText("mobile.paymentAccounts.wise.currencies.summary".i18n(0, 3))
            .assertCountEquals(2)
    }
    ...
    fun `when picker currency clicked then currency summary updates through presenter`() {
        ...
        composeTestRule.waitForIdle()
        composeTestRule
            .onAllNodesWithText("mobile.paymentAccounts.wise.currencies.summary".i18n(2, 3))
            .assertCountEquals(2)
    }
    ...
    fun `when picker search has no results then empty state is shown`() {
        ...
        composeTestRule
            .onNodeWithText("mobile.paymentAccounts.wise.currencies.allSelected".i18n(3))
            .performClick()
        composeTestRule.onNodeWithText("mobile.paymentAccounts.wise.picker.searchHint".i18n()).performTextInput("xyz")
