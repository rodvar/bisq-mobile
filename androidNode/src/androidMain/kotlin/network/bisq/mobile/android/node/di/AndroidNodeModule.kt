...
import network.bisq.mobile.android.node.service.network_stats.NodeNetworkStatsServiceFacade
...
val androidNodeModule = module {
    ...
    single<NetworkStatsServiceFacade> { NodeNetworkStatsServiceFacade(get()) }
